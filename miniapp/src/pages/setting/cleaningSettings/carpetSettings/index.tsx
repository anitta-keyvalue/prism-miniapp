  ...
  useEffect(() => {
    getDeviceInfo({
      ...
      .then(res => {
        ...
        const carpetCleanPrefer = schema.find(
          item => item.code === "carpet_clean_prefer"
        );
        const propertyValue = carpetCleanPrefer
          ? carpetCleanPrefer.property.range
          : null;
  ...
  return (
    <View className={styles.container}>
      <Text className={styles.title}>
        {Strings.getLang("dsc_carpet_settings")}
      </Text>
      <>
        ...
        <Text className={styles.heading}>
          {Strings.getLang("dsc_carpet_clean_preference")}
        </Text>
        <View className={styles.preferenceWrapper}>
          ...
          >
            ...
            <Image
              ...
              className={`${styles.tick} ${
                currentPreference === "adaptive" ? styles.show : ""
              }`}
            />
          </View>
          ...
          >
            ...
            <Image
              src={res.tick}
              className={`${styles.tick} ${
                currentPreference === "evade" ? styles.show : ""
              }`}
            />
          </View>
        </View>
