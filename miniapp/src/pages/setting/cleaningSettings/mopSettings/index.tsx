...
const MopSettings: FC = () => {
  ...
  const [currentAutoHyperArmValue, setAutoHyperArmValue] = useState<boolean>(
    false
  );
  const [currentMopCycleFrequency, setMopCycleFrequency] = useState<string>(
    "1"
  );
  ...
  return (
    <View className={styles.container}>
      <Text className={styles.title}>
        {Strings.getLang("dsc_mop_settings")}
      </Text>
      <View className={styles.content}>
        ...
        <View className={styles.cycleFrequencyWrapper}>
          <Text className={styles.label}>
            {Strings.getLang("dsc_mop_cycle_frequency")}
          </Text>
          <View className={styles.rightSection}>
            <Text
              className={styles.frequencyText}
            >{`${currentMopCycleFrequency} time${
